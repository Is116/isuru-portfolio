    ...
    <article className="min-h-screen bg-stone-50 dark:bg-stone-950">
      ...
      <div className="container-custom py-12 md:py-20">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-stone-600 dark:text-stone-400 leading-relaxed mb-8">
          ...
          <motion.div
            ...
            className="mt-8 p-6 bg-stone-50 dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-800"
          >
            <p className="text-sm text-stone-600 dark:text-stone-400 mb-2 font-semibold">📌 Disclaimer & Context:</p>
      ...
      <div className="container-custom pb-20">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="mb-16 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border-l-4 border-blue-500 p-8 rounded-r-2xl">
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4">Executive Summary</h3>
          ...
          <motion.div variants={fadeInUp} className="mb-16">
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-stone-900 border-2 border-blue-200 dark:border-blue-800 rounded-xl p-6 text-center">
                <FileText className="mx-auto text-blue-600 dark:text-blue-400 mb-3" size={32} />
                <p className="text-3xl font-bold text-stone-900 dark:text-stone-100 mb-2">8,175</p>
                <p className="text-sm text-stone-600 dark:text-stone-400">Documents Processed</p>
              </div>
              <div className="bg-white dark:bg-stone-900 border-2 border-purple-200 dark:border-purple-800 rounded-xl p-6 text-center">
                <Users className="mx-auto text-purple-600 dark:text-purple-400 mb-3" size={32} />
                <p className="text-3xl font-bold text-stone-900 dark:text-stone-100 mb-2">12,243</p>
                <p className="text-sm text-stone-600 dark:text-stone-400">People Identified</p>
              </div>
              <div className="bg-white dark:bg-stone-900 border-2 border-pink-200 dark:border-pink-800 rounded-xl p-6 text-center">
                <Building2 className="mx-auto text-pink-600 dark:text-pink-400 mb-3" size={32} />
                <p className="text-3xl font-bold text-stone-900 dark:text-stone-100 mb-2">5,709</p>
                <p className="text-sm text-stone-600 dark:text-stone-400">Organizations</p>
              </div>
              <div className="bg-white dark:bg-stone-900 border-2 border-green-200 dark:border-green-800 rounded-xl p-6 text-center">
                <MapPin className="mx-auto text-green-600 dark:text-green-400 mb-3" size={32} />
                <p className="text-3xl font-bold text-stone-900 dark:text-stone-100 mb-2">3,211</p>
                <p className="text-sm text-stone-600 dark:text-stone-400">Locations Mapped</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-2 border-purple-200 dark:border-purple-800 p-8 rounded-2xl">
                <h4 className="text-xl font-bold text-stone-900 dark:text-stone-100 mb-4 flex items-center gap-2">
                  <Code size={24} className="text-purple-600 dark:text-purple-400" />
                  OCR Processing Workflow
                </h4>
                <ol className="space-y-4 text-base text-stone-700 dark:text-stone-300">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Save Results:</strong> Each processed page is saved as a JSON file in <code className="px-1.5 py-0.5 bg-stone-100 dark:bg-stone-800 rounded text-xs">./results/&#123;folder&#125;/&#123;imagename&#125;.json</code>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Progress Tracking:</strong> The script maintains <code className="px-1.5 py-0.5 bg-stone-100 dark:bg-stone-800 rounded text-xs">processing_index.json</code> to track which files have been processed (resume-friendly)
                    </div>
                  </li>
                </ol>
              </div>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-6 my-8">
                <div className="bg-white dark:bg-stone-900 border-2 border-purple-200 dark:border-purple-800 rounded-xl p-6">
                  <Users className="text-purple-600 dark:text-purple-400 mb-3" size={32} />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">People</h4>
                ...
                <div className="bg-white dark:bg-stone-900 border-2 border-pink-200 dark:border-pink-800 rounded-xl p-6">
                  <Building2 className="text-pink-600 dark:text-pink-400 mb-3" size={32} />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Organizations</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400 mb-3">
                ...
                <div className="bg-white dark:bg-stone-900 border-2 border-green-200 dark:border-green-800 rounded-xl p-6">
                  <MapPin className="text-green-600 dark:text-green-400 mb-3" size={32} />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Locations</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400 mb-3">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              <p>
                When processing thousands of pages, the AI vision model does not maintain consistency across documents. One page might extract <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">"Epstein"</code>, another <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">"Jeffrey Epstein"</code>, and a third <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">"J. Epstein"</code>. Without deduplication, these would appear as three separate people in the index.
              </p>

              <p>
                The solution is a <strong>second AI pass</strong> dedicated to entity resolution. The script <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">deduplicate.py</code> collects all extracted entities, groups them in batches (default: 50 entities per batch), and sends them to the AI with instructions to identify duplicates and provide a canonical name for each cluster.
              </p>

              <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">4.1 How Deduplication Works</h3>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-900/20 dark:to-yellow-900/20 border-2 border-orange-200 dark:border-orange-800 p-8 rounded-2xl">
                <ol className="space-y-4 text-base text-stone-700 dark:text-stone-300">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Collect Entities:</strong> Scan all JSON files in <code className="px-1.5 py-0.5 bg-stone-100 dark:bg-stone-800 rounded text-xs">./results/</code> and extract all people, organizations, and locations
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Generate Mapping:</strong> Create <code className="px-1.5 py-0.5 bg-stone-100 dark:bg-stone-800 rounded text-xs">dedupe.json</code> with mappings like:
                      <pre className="mt-2 p-3 bg-stone-900 text-gray-100 rounded text-xs overflow-x-auto">
{`{
  "people": {
    ...
    "Jeffrey Epstein": "Jeffrey Epstein"
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              <p>
                Legal document releases typically arrive as a folder of individual page scans: <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">page_001.jpg</code>, <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">page_002.jpg</code>, and so on. But each document spans multiple pages. A deposition might be 50 pages. A financial record might be 200.
              </p>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <p>
                The script <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">analyze_documents.py</code> groups pages into complete documents (using the reconstruction logic) and sends the <strong>full text of each document</strong> to an AI model with instructions to generate:
              </p>

              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-white dark:bg-stone-900 border border-cyan-200 dark:border-cyan-800 rounded-xl p-6">
                  <Brain className="text-cyan-600 dark:text-cyan-400 mb-3" size={28} />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Executive Summary</h4>
                ...
                <div className="bg-white dark:bg-stone-900 border border-cyan-200 dark:border-cyan-800 rounded-xl p-6">
                  ...
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Key Topics</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400">
                ...
                <div className="bg-white dark:bg-stone-900 border border-cyan-200 dark:border-cyan-800 rounded-xl p-6">
                  ...
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Key People</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400">
                ...
                <div className="bg-white dark:bg-stone-900 border border-cyan-200 dark:border-cyan-800 rounded-xl p-6">
                  ...
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Significance</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400">
              ...
              <p>
                All analyses are saved to <code className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded">analyses.json</code> and automatically incorporated into the searchable website. The script is resume-friendly   it skips documents already analyzed unless forced to re-run.
              </p>
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 border-l-4 border-purple-500 p-6 rounded-r-xl">
                ...
                <pre className="text-xs bg-stone-900 text-gray-100 p-4 rounded overflow-x-auto leading-relaxed">
{`{
  ...
  "summary": "This deposition contains testimony regarding..."
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border-2 border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
                  ...
                  <h4 className="text-xl font-bold text-stone-900 dark:text-stone-100 mb-3">Python Processing Layer</h4>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-xl p-6">
                  ...
                  <h4 className="text-xl font-bold text-stone-900 dark:text-stone-100 mb-3">Static Website Layer</h4>
                  <ul className="space-y-2 text-sm text-stone-700 dark:text-stone-300">
                    <li className="flex items-start gap-2">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 border-l-4 border-indigo-500 p-6 rounded-r-xl mt-8">
                ...
                <p className="text-stone-800 dark:text-stone-200 mb-3">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-stone-900 border-2 border-red-200 dark:border-red-800 rounded-xl p-6">
                  <Zap className="text-red-600 dark:text-red-400 mb-3" size={28} />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">OCR Processing</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400">~2-5 seconds per page with 5 concurrent workers. Total: several hours for full corpus.</p>
                </div>
                <div className="bg-white dark:bg-stone-900 border-2 border-orange-200 dark:border-orange-800 rounded-xl p-6">
                  <Filter className="text-orange-600 dark:text-orange-400 mb-3" size={28} />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Deduplication</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400">Batches of 50 entities. ~10-30 seconds per batch. Runs once after OCR completes.</p>
                </div>
                <div className="bg-white dark:bg-stone-900 border-2 border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
                  <Brain className="text-yellow-600 dark:text-yellow-400 mb-3" size={28} />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">AI Analysis</h4>
                  <p className="text-sm text-stone-600 dark:text-stone-400">~10-20 seconds per multi-page document. Total: a few hours for ~400 documents.</p>
                </div>
              </div>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-2 border-purple-200 dark:border-purple-800 p-8 rounded-2xl">
                ...
                <ul className="space-y-3 text-base text-stone-700 dark:text-stone-300">
                  <li className="flex items-start gap-3">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="bg-gradient-to-r from-stone-100 to-stone-200 dark:from-stone-800 dark:to-stone-900 border-l-4 border-stone-500 p-8 rounded-r-2xl my-8">
                <p className="text-xl font-bold text-stone-900 dark:text-stone-100 mb-4">
          ...
          {/* References */}
          <motion.section variants={fadeInUp} className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 dark:text-stone-100 mb-8">References & Resources</h2>

            <div className="bg-stone-50 dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-2xl p-8">
              <ol className="space-y-4 text-sm text-stone-700 dark:text-stone-300 leading-relaxed list-decimal list-inside">
                <li>
          ...
          <motion.div variants={fadeInUp} className="text-center pt-12 border-t border-stone-200 dark:border-stone-800">
            <Link 
              href="/#articles"
