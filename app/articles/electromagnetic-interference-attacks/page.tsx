    ...
    <article className="min-h-screen bg-stone-50 dark:bg-stone-950">
      ...
      <div className="container-custom py-12 md:py-20">
        ...
        >
          ...
          >
            <p className="text-sm text-stone-600 dark:text-stone-400 mb-2 font-semibold">Research Sources:</p>
      ...
      <div className="container-custom pb-20">
        ...
        >
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-6">
                  ...
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Radiated Coupling</h4>
                ...
                <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-6">
                  ...
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-2">Conducted Coupling</h4>
                  <p className="text-base text-stone-600 dark:text-stone-400">
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">1.1 Coupling Pathways: Radiated vs. Conducted</h3>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">2.1 How Ring Oscillators Generate Randomness</h3>
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">2.2 The Injection Lock: Turning Chaos into Clockwork</h3>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">3.1 Why Flip-Chip Packaging Is an Attack Surface</h3>
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="bg-stone-100 dark:bg-stone-800 rounded-xl p-8 text-center my-8 border-2 border-dashed border-stone-300 dark:border-stone-700">
                <Cpu className="mx-auto text-stone-400 dark:text-stone-600 mb-4" size={64} />
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">3.2 The Mechanism: From Pulse to Bit-Flip</h3>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">4.1 The Core Principle: How Noise Becomes a Timing Error</h3>
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">4.2 The Modified Model: Adding a Low-Pass Filter</h3>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">5.1 Brokenwire: Halting Electric Vehicle Charging</h3>
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="bg-white dark:bg-stone-900 border-2 border-orange-200 dark:border-orange-800 rounded-xl p-6 my-8">
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  <div>
                    <p className="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2">10 mW</p>
                    <p className="text-sm text-stone-600 dark:text-stone-400">Power needed from 10 meters</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2">&lt;1 W</p>
                    <p className="text-sm text-stone-600 dark:text-stone-400">Power needed from 47 meters</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2">8/20</p>
                    <p className="text-sm text-stone-600 dark:text-stone-400">Vehicles/chargers tested</p>
                  </div>
                </div>
              </div>
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">5.2 ESIA: Attacking Autonomous Vehicle Cameras</h3>
            ...
            <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-4 mt-12">5.3 Tesla Autopilot: Fault Injection Against Automotive Chips</h3>
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-6 rounded-r-xl my-8">
                <p className="text-stone-800 dark:text-stone-200 font-semibold mb-2">Critical Insight:</p>
            ...
            <div className="space-y-8 mt-12">
              ...
              <div className="bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 border-l-4 border-cyan-500 p-8 rounded-r-2xl">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-3">Layer 1: Physical Shielding</h3>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border-l-4 border-blue-500 p-8 rounded-r-2xl">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-3">Layer 2: PCB Layout Discipline</h3>
                    <p className="text-lg text-stone-700 dark:text-stone-300 leading-relaxed mb-4">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-l-4 border-purple-500 p-8 rounded-r-2xl">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-3">Layer 3: Circuit-Level Resilience</h3>
                    <p className="text-lg text-stone-700 dark:text-stone-300 leading-relaxed mb-4">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 dark:text-stone-100 mb-8 flex items-center gap-3">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse bg-white dark:bg-stone-900 rounded-xl overflow-hidden shadow-lg">
                <thead>
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                  <tr className="hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors">
                    <td className="p-4 font-semibold text-stone-900 dark:text-stone-100">Oscillator Locking</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Near system clock frequency of ring oscillators</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Markettos & Moore, CHES 2009</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Multiple entropy sources + online randomness testing</td>
                  </tr>
                  <tr className="hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors">
                    <td className="p-4 font-semibold text-stone-900 dark:text-stone-100">Bit-Flipping (HVP)</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">High-voltage pulse on Si substrate backside</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Kobe University, IEEE TEMC 2024</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">ECC memory + backside buried metal (BBM) shielding</td>
                  </tr>
                  <tr className="hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors">
                    <td className="p-4 font-semibold text-stone-900 dark:text-stone-100">Clock Jitter / Timing Error</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Amplitude & frequency of RFI vs. gate switching parameters</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Robinson et al., IEEE TEMC 2003</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Low-pass filtering + slowest logic family + via fences</td>
                  </tr>
                  <tr className="hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors">
                    <td className="p-4 font-semibold text-stone-900 dark:text-stone-100">Harmonic Coupling</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Sub-harmonics (½, ¼) of target clock frequency</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">General EMC theory; Robinson et al. 2003</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Low-pass filters on all signal lines</td>
                  </tr>
                  <tr className="hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors">
                    <td className="p-4 font-semibold text-stone-900 dark:text-stone-100">PLC Disruption (Brokenwire)</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">HomePlug GreenPHY preamble frequency (~17 MHz)</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Köhler et al., NDSS 2023</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Shielded/balanced cabling + protocol-level timeout hardening</td>
                  </tr>
                  <tr className="hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors">
                    <td className="p-4 font-semibold text-stone-900 dark:text-stone-100">Camera Signal Injection (ESIA)</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Synchronized to camera rolling shutter rate</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Jiang et al. 2023; Zhang et al. 2024</td>
                    <td className="p-4 text-stone-700 dark:text-stone-300">Image-level anomaly detection + sensor fusion</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="bg-gradient-to-r from-stone-100 to-stone-200 dark:from-stone-800 dark:to-stone-900 border-l-4 border-stone-500 p-8 rounded-r-2xl my-8">
                ...
                <p className="text-lg text-stone-700 dark:text-stone-300 italic">
          ...
          {/* References */}
          <motion.section variants={fadeInUp} className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 dark:text-stone-100 mb-8">References</h2>
