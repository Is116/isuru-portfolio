        ...
        >
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-8">
              {/* Ultra-Budget DIY */}
              <div className="bg-white dark:bg-stone-800/50 border-2 border-accent-200 dark:border-accent-500/30 rounded-2xl p-8 shadow-lg">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-stone-600 dark:text-stone-400">$20 - $100</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-stone-700 dark:text-stone-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <div className="bg-stone-50 dark:bg-stone-900/50 rounded-lg p-4 border border-accent-200 dark:border-accent-500/30">
              ...
              <div className="bg-white dark:bg-stone-800/50 border-2 border-accent-200 dark:border-accent-500/30 rounded-2xl p-8 shadow-lg">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-stone-600 dark:text-stone-400">$100 - $300</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl p-6 border border-blue-300 dark:border-blue-600/30">
                    ...
                    <p className="text-sm text-stone-700 dark:text-stone-300 mb-3">~$100</p>
                    <ul className="text-sm text-stone-700 dark:text-stone-300 space-y-2">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-300 dark:border-purple-600/30">
                    ...
                    <p className="text-sm text-stone-700 dark:text-stone-300 mb-3">~$250-$350</p>
                    <ul className="text-sm text-stone-700 dark:text-stone-300 space-y-2">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6 border border-green-300 dark:border-green-600/30">
                    ...
                    <p className="text-sm text-stone-700 dark:text-stone-300 mb-3">~$200-$300</p>
                    <ul className="text-sm text-stone-700 dark:text-stone-300 space-y-2">
              ...
              <div className="bg-white dark:bg-stone-800/50 border-2 border-accent-200 dark:border-accent-500/30 rounded-2xl p-8 shadow-lg">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-stone-600 dark:text-stone-400">$300 - $1,000</p>
                  </div>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-stone-50 dark:bg-stone-900/50 rounded-lg p-6 border border-accent-200 dark:border-accent-500/30">
                    <h4 className="font-bold text-accent-600 dark:text-accent-400 mb-3">OpenBCI Systems</h4>
                    <p className="text-sm text-stone-700 dark:text-stone-300 mb-3">$500-$1,500</p>
                  ...
                  <div className="bg-stone-50 dark:bg-stone-900/50 rounded-lg p-6 border border-accent-200 dark:border-accent-500/30">
                    ...
                    <p className="text-sm text-stone-700 dark:text-stone-300 mb-3">~$500</p>
                    <p className="text-sm text-stone-700 dark:text-stone-300">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="bg-white dark:bg-stone-800/50 border border-accent-200 dark:border-accent-500/30 rounded-xl p-6 hover:border-accent-500 dark:hover:border-accent-400 transition-all shadow-sm hover:shadow-lg">
                  ...
                  <p className="text-stone-700 dark:text-stone-300 leading-relaxed">{app.desc}</p>
                </div>
              ))}
            </div>
          </motion.section>
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="bg-gradient-to-br from-accent-50 to-blue-50 dark:from-accent-900/20 dark:to-blue-900/20 border-2 border-accent-500 rounded-2xl p-8 shadow-xl mb-8">
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-stone-800/50 rounded-xl p-6 border border-accent-300 dark:border-accent-600/30">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-stone-800/50 border border-accent-200 dark:border-accent-500/30 rounded-xl p-6">
            ...
            <div className="mt-6 bg-stone-50 dark:bg-stone-950 rounded-xl p-6 border-l-4 border-accent-500 overflow-x-auto">
              <div className="text-sm text-stone-600 dark:text-stone-400 mb-3 font-mono">Example: EEG Signal Processing Pipeline</div>
...
prediction = clf.predict(features_test)`}
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white dark:bg-stone-800/50 border border-red-200 dark:border-red-500/30 rounded-xl p-6">
              ...
              <div className="bg-white dark:bg-stone-800/50 border border-green-200 dark:border-green-500/30 rounded-xl p-6">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="space-y-6 text-lg text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <div className="bg-accent-50 dark:bg-accent-900/20 border-l-4 border-accent-500 p-8 rounded-r-xl my-8 shadow-xl">
                <p className="text-xl italic text-stone-800 dark:text-stone-200">
          ...
          <motion.section variants={fadeInUp} className="mb-16">
            ...
            <div className="bg-stone-50 dark:bg-stone-900/50 rounded-xl p-8 border border-stone-200 dark:border-stone-700">
